...
klauzuluj (Implikacja a b) = klauzuluj (Alternatywa (Negacja a) b)
klauzuluj (Rownowaznosc a b) = klauzuluj (Koniunkcja (Implikacja a b) (Implikacja b a))
klauzuluj (Koniunkcja a b) = klauzuluj (Negacja ( Alternatywa (Negacja a) (Negacja b)) )
